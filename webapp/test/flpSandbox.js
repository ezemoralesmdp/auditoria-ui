		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Auditoria",
									"targetURL": "#audituiauditoriaui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"audituiauditoriaui-display": {
								"semanticObject": "audituiauditoriaui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=auditui.auditoriaui",
									"url": sap.ui.require.toUrl("auditui/auditoriaui")
								}
							}
						}
					}
